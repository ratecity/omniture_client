...
OmnitureClient::config(YAML::load(File.open(File.join(Rails.root.to_s, 'config', 'omniture.yml')))[Rails.env]) if File.exists?(File.join(Rails.root.to_s, 'config', 'omniture.yml'))
